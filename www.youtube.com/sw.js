...
ytcfg.set({
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20231219.04.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "hl": "en-GB",
            "gl": "IN",
    ...
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20231219.04.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    var policy = self.trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(unused) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/28b0985e\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(policy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/28b0985e\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}