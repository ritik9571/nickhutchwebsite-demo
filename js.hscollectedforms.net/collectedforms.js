! function() {
    ...
    var F, O, x, C = h ? function(t, e, r) {
        ...
        K = {
            f: h ? Y : function(t, e) {
                ...
                if (X(t, e)) return E(!G.f.call(t, e), t[e])
            }
        },
    ...
    var qt = M("toStringTag"),
        ...
        Qt = {};
    Qt[M("toStringTag")] = "z";
    var Ht = "[object z]" !== String(Qt) ? function() {
            return "[object " + Gt(this) + "]"
        } : Qt.toString,
        Wt = Object.prototype;
    Ht !== Wt.toString && pt(Wt, "toString", Ht, {
        unsafe: !0
    });
    var Jt = w.f,
        Xt = M("toStringTag"),
        ...
        ne = function(t) {
            var e = re(t),
                r = Tt.f;
            if (r)
                for (var n, i = r(t), o = G.f, s = 0; i.length > s;) o.call(t, n = i[s++]) && e.push(n);
            return e
        },
    ...
    for (var He = re(Re), We = 0; He.length > We;) ee(He[We++]);
    kt({
        target: ye,
        stat: !0,
        forced: !k
    ...
    var nr = Object.assign,
        ir = !nr || d((function() {
            ...
            for (var r = o(t), n = arguments.length, i = 1, s = Tt.f, a = G.f; n > i;)
                for (var u, c = H(arguments[i++]), l = s ? re(c).concat(s(c)) : re(c), f = l.length, d = 0; f > d;) a.call(c, u = l[d++]) && (r[u] = c[u]);
            return r
        } : nr;
    kt({
        target: "Object",
...
! function(t) {
    ...
    r.p = "//static.hsappstatic.net/collected-forms-embed-js/static-1.444/";
    r(r.s = "nhqU")
}({
    "3eCO": function(t, e, r) {
        (function(e) {
    ...
    OXtA: function(t, e) {
        t.exports = {
            ...
            bender: {
                depVersions: {
                    "collected-forms-embed-js": "static-1.444",
                    "browserslist-config-hubspot": "static-1.78",
                    csstype: "static-1.8",
                    "forms-embed-utils-lib": "static-1.170",
                    jasmine: "static-4.87",
                    "jasmine-runner": "static-1.451",
                    outpost: "static-1.206",
                    quartz: "static-1.716",
                    react: "static-7.96",
                    "react-dom": "static-7.62",
                    sinon: "static-1.9",
                    StyleGuideUI: "static-3.361"
                },
                depPathPrefixes: {
                    "collected-forms-embed-js": "/collected-forms-embed-js/static-1.444",
                    "browserslist-config-hubspot": "/browserslist-config-hubspot/static-1.78",
                    csstype: "/csstype/static-1.8",
                    "forms-embed-utils-lib": "/forms-embed-utils-lib/static-1.170",
                    jasmine: "/jasmine/static-4.87",
                    "jasmine-runner": "/jasmine-runner/static-1.451",
                    outpost: "/outpost/static-1.206",
                    quartz: "/quartz/static-1.716",
                    react: "/react/static-7.96",
                    "react-dom": "/react-dom/static-7.62",
                    sinon: "/sinon/static-1.9",
                    StyleGuideUI: "/StyleGuideUI/static-3.361"
                },
    ...
    nhqU: function(t, e, r) {
        ...
        class Xr {
            isMarkedField(t) {
                return t.get(Sr.ATTRIBUTES)[Qr] > -1
            }
            isContainingLabeledField(t) {
                return Hr.filter(e => t.getLowerCased(Sr.LABEL).indexOf(e) > -1).length > 0
            }
            isMatchingLabeledField(t) {
        ...
        class hn {
            ...
            createSubmissionContactFieldsFromSubmissionFields(t) {
                ...
                return Object.assign({}, t, {
                    submissionContactFields: r.setEmailField(Br.findBest(e)).setFirstNameField(Gr.findBest(e)).setLastNameField(Yr.findBest(e)).setPhoneNumberField(on.findBest(e))
                })
            }
        ...
        var En = {
            ...
            setupAnalyticsReporting(t) {
                ...
                wn.analyticsReporter = new vn(H(), n);
                return t
            },
...
//# sourceMappingURL=//static.hsappstatic.net/collected-forms-embed-js/static-1.444/bundles/project.js.map